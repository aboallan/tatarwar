...
6. Shared reference data (departments, agenda slots, venues, highlights) now comes from the database through helper functions in `repository.php`; adjust the database records (or update that helper if you need temporary fallbacks).
