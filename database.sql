-- The PHP bootstrap in config.php now creates this schema automatically if it does not exist.
-- You can still run the statements manually when you prefer to manage the database yourself.
