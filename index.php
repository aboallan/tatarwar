        ...
        <aside class="workspace__sidebar" aria-label="Primary navigation">
            ...
            <div class="sidebar__section">
                ...
                <ul class="sidebar__list sidebar__list--actions">
                    <li><a href="dashboard-agenda.php">Attendance Dashboard</a></li>
            ...
            <footer class="sidebar__footer">
                <?php if ($hasAccount): ?>
                    <a class="btn btn--secondary btn--full" href="dashboard-agenda.php">Go to Dashboard</a>
        ...
        <div class="workspace__content" id="overview">
            ...
            <header class="workspace__header">
                ...
                <div class="workspace__actions">
                    <a class="btn btn--primary" href="dashboard-agenda.php#add-meeting">Schedule Meeting</a>
                    <?php if ($hasAccount): ?>
                        <a class="btn btn--ghost" href="dashboard-agenda.php">Open Dashboard</a>
                    <?php else: ?>
